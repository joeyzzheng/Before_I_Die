var render_bucket_item = function(i) {
	...
	var description = '<div class="item-desc">' + bucket_list[i].content + '</div>';
	...
	var like = '<img onClick="like('+i+')" class="icon-like" alt="like button" src="../resource/pic/like.png"><span class="count-of-like">' + bucket_list[i].like + '</span><img class="torch" src="../resource/pic/torch.png" alt="torch>">';
