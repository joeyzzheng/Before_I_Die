...
(
  ...
  `ProfilePic` VARCHAR(200) NULL DEFAULT '/resource/pic/profilePic/default_profile_pic.png',
...
(
  ...
  `Image` VARCHAR(200) NULL DEFAULT '/resource/pic/bucketPic/default_bucket_pic.jpg',
