...
(
  ...
  `ProfilePic` VARCHAR(200) NULL DEFAULT '/resource/pic/profilePic/default-profile-pic.png',
...
(
  ...
  `Image` VARCHAR(200) NULL DEFAULT '/resource/pic/bucketPic/default-bucket-pic.jpg',
